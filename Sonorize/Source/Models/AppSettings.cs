...
public class LastfmSettings
{
    ...
    public string? Password { get; set; } // Used for initial authentication to get a session key.
    public string? SessionKey { get; set; } // Stores the authenticated session key.
