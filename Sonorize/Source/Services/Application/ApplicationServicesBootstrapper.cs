...
public class ApplicationServicesBootstrapper
{
    public MainWindowViewModel Bootstrap(SettingsService settingsService, ThemeColors currentCustomTheme)
    {
        ...
        var songEditInteractionService = new SongEditInteractionService(playbackService, songMetadataService, currentCustomTheme); // Create new service
        ...
        var mainWindowViewModel = new MainWindowViewModel(
            ...
            scrobblingService,
            songMetadataService,
            songEditInteractionService); // Pass new service
