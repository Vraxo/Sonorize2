...
public static class MainMenu
{
    public static Menu Create(ThemeColors theme, Window ownerWindow)
    {
        ...
        artDetailed.Bind(MenuItem.CommandProperty, new Binding("LibraryDisplayModeService.SetDisplayModeCommand"));
        ...
        artCompact.Bind(MenuItem.CommandProperty, new Binding("LibraryDisplayModeService.SetDisplayModeCommand"));
        ...
        artGrid.Bind(MenuItem.CommandProperty, new Binding("LibraryDisplayModeService.SetDisplayModeCommand"));
        ...
        albDetailed.Bind(MenuItem.CommandProperty, new Binding("LibraryDisplayModeService.SetDisplayModeCommand"));
        ...
        albCompact.Bind(MenuItem.CommandProperty, new Binding("LibraryDisplayModeService.SetDisplayModeCommand"));
        ...
        albGrid.Bind(MenuItem.CommandProperty, new Binding("LibraryDisplayModeService.SetDisplayModeCommand"));
        ...
        playDetailed.Bind(MenuItem.CommandProperty, new Binding("LibraryDisplayModeService.SetDisplayModeCommand"));
        ...
        playCompact.Bind(MenuItem.CommandProperty, new Binding("LibraryDisplayModeService.SetDisplayModeCommand"));
        ...
        playGrid.Bind(MenuItem.CommandProperty, new Binding("LibraryDisplayModeService.SetDisplayModeCommand"));
